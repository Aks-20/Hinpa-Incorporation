  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-20 h-20 bg-orange-200 rounded-full opacity-20"></div>
        <div className="absolute bottom-40 left-10 w-16 h-16 bg-orange-200 transform rotate-45 opacity-20"></div>
        <div className="absolute top-1/2 right-1/3 w-12 h-12 bg-orange-100 rounded-full opacity-20"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6">
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 bg-orange-500 rounded-lg flex items-center justify-center text-white">
                    {benefit.icon}
                  </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="space-y-4">
                {openRoles.map((role, index) => (
                  <div
                    key={index}
                    className="border border-gray-200 rounded-lg p-4 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 group cursor-pointer"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h4 className="text-lg font-semibold text-gray-900 group-hover:text-orange-300 transition-colors">
                          {role.title}
                        </h4>
                        <div className="flex items-center space-x-4 mt-2 text-sm text-gray-600">
                          <span>{role.location}</span>
                          <span className="bg-orange-100 text-orange-400 px-2 py-1 rounded">
                            {role.type}
                          </span>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <button className="w-full bg-orange-400 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center group">
                  View All Openings
            ...
            <div className="bg-orange-400 rounded-2xl p-8 text-white">
              ...
              <blockquote className="text-orange-100 italic mb-4">
        ...
        <div className="text-center">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-orange-400 text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-400 transition-colors flex items-center justify-center">
                Send Your Resume
                <ArrowRight className="ml-2 w-4 h-4" />
              </button>
              <button className="border-2 border-gray-300 text-gray-700 px-8 py-3 rounded-lg font-semibold hover:border-orange-400 hover:text-orange-300 transition-colors">
